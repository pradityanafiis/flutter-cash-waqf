...
class WaqfProgramCubit extends Cubit<WaqfProgramState> {
  late final WaqfProgramService _waqfProgramSerice;

  WaqfProgramCubit({WaqfProgramService? waqfProgramService})
      : super(WaqfProgramInitialState()) {
    this._waqfProgramSerice =
