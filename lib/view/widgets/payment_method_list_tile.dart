...
class PaymentMethodListTile extends StatelessWidget {
  ...
  final String _tanggalKedaluwarsa;
  final String _waktuKedaluwarsa;

  PaymentMethodListTile(
    this._paymentMethod,
    this._paymentCode,
    this._paymentStatus,
    this._tanggalKedaluwarsa,
    this._waktuKedaluwarsa,
  );
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      subtitle: (_paymentStatus == "pending")
          ? Text("$_tanggalKedaluwarsa, $_waktuKedaluwarsa")
          : Text(_paymentStatus.toPaymentStatusDisplay()),
