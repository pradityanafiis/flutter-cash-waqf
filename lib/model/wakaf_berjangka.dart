...
class WakafBerjangka extends Wakaf {
  ...
  String? tanggalKedaluwarsaPembayaran;
  String? waktuKedaluwarsaPembayaran;
  ...
  WakafBerjangka({
    ...
    this.waktuKedaluwarsaPembayaran,
  ...
  factory WakafBerjangka.createFromJson(Map<String, dynamic> data) =>
      WakafBerjangka(
        ...
        tanggalKedaluwarsaPembayaran: data['tanggal_kedaluwarsa_pembayaran'],
        waktuKedaluwarsaPembayaran: data['waktu_kedaluwarsa_pembayaran'],
